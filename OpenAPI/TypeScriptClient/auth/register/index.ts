...
// @ts-ignore
import { createAccessTokensDtoFromDiscriminatorValue, serializeAccessTokensDto, serializeRegisterUserDto, type AccessTokensDto, type RegisterUserDto } from '../../models/index.js';
// @ts-ignore
...
export interface RegisterRequestBuilder extends BaseRequestBuilder<RegisterRequestBuilder> {
     ...
     * @returns {Promise<AccessTokensDto>}
     */
     post(body: RegisterUserDto, requestConfiguration?: RequestConfiguration<object> | undefined) : Promise<AccessTokensDto | undefined>;
    /**
     * @param body The request body
     * @param requestConfiguration Configuration for the request such as headers, query parameters, and middleware options.
...
export const RegisterRequestBuilderRequestsMetadata: RequestsMetadata = {
    post: {
        ...
        responseBodyFactory:  createAccessTokensDtoFromDiscriminatorValue,
