...
// @ts-ignore
import { createEntryDtoFromDiscriminatorValue, serializeCreateEntryDto, serializeEntryDto, type CreateEntryDto, type EntryDto } from '../models/index.js';
// @ts-ignore
...
export interface EntriesRequestBuilder extends BaseRequestBuilder<EntriesRequestBuilder> {
     ...
     */
     get(requestConfiguration?: RequestConfiguration<EntriesRequestBuilderGetQueryParameters> | undefined) : Promise<ArrayBuffer | undefined>;
    /**
